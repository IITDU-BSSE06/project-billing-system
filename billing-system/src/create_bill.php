...
<div style="width: 1200px; margin: 0 auto;">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          <button onclick="location.href='index.php'" type="submit" class="btn btn-primary" id="sign_upTop">Sign out</button>
        </ul>
      </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
  </nav>
  <div class="row" style="height: 550px;">
    ...
    <div class="col-sm-7" style=" border-right: 1px solid #BBCDBC;">
      ...
      <form id="form" name="programName" action="fill_form.php" method="post" style="width: 500px; align-content: flex-end;">
        <div>
          <p></p>
